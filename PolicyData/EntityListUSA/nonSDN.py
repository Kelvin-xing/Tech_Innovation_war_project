...
def parse_xml(file_path):
    ...
    writer = pd.ExcelWriter('./Policy_data/Entity_list_USA/non-sdn.xlsx', engine='xlsxwriter')
    for i, child_df in enumerate(child_dfs):
        child_df.to_excel(writer, sheet_name=f'Child {i+1}', index_label='Column Name')
    writer.save()

# Example usage
file = '/Users/mingjiexing/Desktop/Python/Tech_Innovation_war_project/Policy_data/Treasury_list/nonsdn_cons_advanced.xml'
parse_xml(file)